...
class FinalMutationOperator(MutationOperator):
    ...
    def mutate(self, point: ChaosNet) -> ChaosNet:
        ...
        # point.mutation_radius = conditional_uniform_value_shift(p_pm, point.mutation_radius,       -5,  0, rad_frac)
        #
        # point.wb_mutation_prob = conditional_uniform_value_shift(p_pm, point.wb_mutation_prob,     -5,  0, rad_frac)
        #
        # point.s_mutation_prob = conditional_uniform_value_shift(p_pm, point.s_mutation_prob,       -5,  0, rad_frac)
        #
        # point.p_mutation_prob = conditional_uniform_value_shift(p_pm, point.p_mutation_prob,       -2,  0, rad_frac)
        #
        # point.c_prob = conditional_uniform_value_shift(p_pm, point.c_prob,                         -1,  0, rad_frac)
        #
        # point.r_prob = conditional_uniform_value_shift(p_pm, point.r_prob,                         -5,  0, rad_frac)
